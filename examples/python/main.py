"""
Example: How to call the ynet actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/ynet
...
def run_actor():
    """Run the ynet actor and retrieve results."""
